...
<a href="{{ route('jenjang-pendidikan.create') }}" type="button" class="btn btn-success mb-3">Add</a>
        ...
        <tbody>
          @foreach ($jenjangPendidikan as $jenjang)
            <tr>
              ...
              <td>
                <a class="btn btn-primary" type="button" href="{{ route('jenjang-pendidikan.edit', $jenjang->id) }}">Edit</a>
