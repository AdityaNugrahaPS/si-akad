        ...
        <div class="row">
          <div class="col-md-6 mb-3">
            ...
            <input type="text" class="form-control @error('nama_lengkap')
              is-invalid
            @enderror" id="nama_lengkap" name="nama_lengkap" value="{{ old('nama_lengkap') ?? $guru->nama_lengkap }}">
            @error('nama_lengkap')
          ...
          <div class="col-md-6 mb-3">
            ...
            <input type="text" class="form-control @error('nip')
              is-invalid
            @enderror" id="nip" name="nip" value="{{ old('nip') ?? $guru->nip }}">
            @error('nip')
              <div class="invalid-feedback text-danger">
                {{ $message }}
              </div>
          ...
          <div class="col-md-6 mb-3">
            ...
            <input type="text" class="form-control @error('nik')
              is-invalid
            @enderror" id="nik" name="nik" value="{{ old('nik') ?? $guru->nik }}">
            @error('nik')
              <div class="invalid-feedback text-danger">
                {{ $message }}
              </div>
          ...
          <div class="col-md-6 mb-3">
            ...
            <input type="text" class="form-control @error('tempat_lahir')
              is-invalid
            @enderror" id="tempat_lahir" name="tempat_lahir" value="{{ old('tempat_lahir') ?? $guru->tempat_lahir }}">
            @error('tempat_lahir')
              <div class="invalid-feedback text-danger">
                {{ $message }}
              </div>
          ...
          <div class="col-md-6 mb-3">
            ...
            <input type="date" class="form-control @error('tanggal_lahir')
              is-invalid
            @enderror" id="tanggal_lahir" name="tanggal_lahir" value="{{ old('tanggal_lahir') ?? $guru->tanggal_lahir }}">
            @error('tanggal_lahir')
              <div class="invalid-feedback text-danger">
                {{ $message }}
              </div>
          ...
          <div class="col-md-6 mb-3">
            ...
            <input type="text" class="form-control @error('alamat')
              is-invalid
            @enderror" id="alamat" name="alamat" value="{{ old('alamat') ?? $guru->alamat }}">
            @error('alamat')
              <div class="invalid-feedback text-danger">
                {{ $message }}
              </div>
          ...
          <div class="col-md-6 mb-3">
            ...
            <input type="text" class="form-control @error('gelar_depan')
              is-invalid
            @enderror" id="gelar_depan" name="gelar_depan" value="{{ old('gelar_depan') ?? $guru->gelar_depan }}">
            @error('gelar_depan')
              <div class="invalid-feedback text-danger">
                {{ $message }}
              </div>
          ...
          <div class="col-md-6 mb-3">
            ...
            <input type="text" class="form-control @error('gelar_belakang')
              is-invalid
            @enderror" id="gelar_belakang" name="gelar_belakang" value="{{ old('gelar_belakang') ?? $guru->gelar_belakang }}">
          ...
          <div class="col-md-6 mb-3">
            ...
            <input type="text" class="form-control @error('pendidikan_terakhir')
              is-invalid
            @enderror" id="pendidikan_terakhir" name="pendidikan_terakhir" value="{{ old('pendidikan_terakhir') ?? $guru->pendidikan_terakhir }}">
          ...
          <div class="col-md-6 mb-3">
            ...
            <input type="text" class="form-control @error('email')
              is-invalid
            @enderror" id="email" name="email" value="{{ old('email') ?? $guru->email }}">
            @error('email')
              <div class="invalid-feedback text-danger">
                {{ $message }}
              </div>
          ...
          <div class="col-md-6 mb-3">
            ...
            <input type="text" class="form-control @error('telp')
              is-invalid
            @enderror" id="telp" name="telp" value="{{ old('telp') ?? $guru->telp }}">
            @error('telp')
              <div class="invalid-feedback text-danger">
                {{ $message }}
              </div>
