...
@section('content')
  <ul class="breadcrumb">
    ...
    <div class="card-header">
      <h3 class="mb-4"><i class="fa fa-user-plus"></i> Tambah Guru</h3>
      <form action="{{ route('guru.store') }}" method="POST">
        ...
        <div class="row">
          ...
          <div class="col-md-6 mb-3">
            ...
            <input type="text" class="form-control @error('gelar_depan') is-invalid @enderror" id="gelar_depan" name="gelar_depan" value="{{ old('gelar_depan') }}">
            @error('gelar_depan')
              <div class="invalid-feedback text-danger">
                {{ $message }}
              </div>
          ...
          <div class="col-md-6 mb-3">
            ...
            <input type="text" class="form-control @error('gelar_belakang') is-invalid @enderror" id="gelar_belakang" name="gelar_belakang" value="{{ old('gelar_belakang') }}">
