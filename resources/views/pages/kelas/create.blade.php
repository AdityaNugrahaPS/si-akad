...
@section('content')
  ...
  <div class="card">
    <div class="card-header">
      <h3 class="mb-4"><i class="fa fa-plus-square"></i> Tambah Kelas</h3>
      <form action="{{ route('kelas.store') }}" method="POST">
        ...
        <div class="row">
          ...
          <div class="col-md-6 mb-3">
            <label for="tingkat" class="form-label"><i class="fa fa-level-up"></i> Tingkat<span class="text-danger">*</span></label>
          ...
          <div class="col-md-6 mb-3">
            ...
            <input type="text" class="form-control @error('kode_kelas') is-invalid @enderror" id="kode_kelas" name="kode_kelas" value="{{ old('kode_kelas') }}">
            @error('kode_kelas')
              <div class="invalid-feedback text-danger">
                {{ $message }}
              </div>
