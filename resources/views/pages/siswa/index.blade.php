...
<a href="{{ route('siswa.create') }}" type="button" class="btn btn-success mb-3">Add</a>
        ...
        <tbody>
          @foreach ($siswas as $siswa)
            <tr>
              ...
              <td><img src="{{ asset('storage/' . $siswa->foto) }}" width="50" height="50" alt="Foto Siswa"></td>
              ...
              <td>
                <a class="btn btn-primary" type="button" href="{{ route('siswa.edit', $siswa->id) }}">Edit</a>
