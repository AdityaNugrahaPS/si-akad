                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control @error('nama_lengkap') is-invalid @enderror"
                            id="nama_lengkap" name="nama_lengkap" value="{{ old('nama_lengkap') ?? $siswa->nama_lengkap }}">
                        @error('nama_lengkap')
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select name="agama" id="agama" class="form-select @error('agama') is-invalid @enderror">
                            ...
                            <option value="Kristen Katolik"
                                {{ (old('agama') ?? $siswa->agama) === 'Kristen Katolik' ? 'selected' : '' }}>Kristen
                                Katolik</option>
                            ...
                            <option value="Khonghucu"
                                {{ (old('agama') ?? $siswa->agama) === 'Khonghucu' ? 'selected' : '' }}>Khonghucu</option>
                        </select>
                        @error('agama')
                            <div class="invalid-feedback text-danger">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control @error('nikk') is-invalid @enderror" id="nikk"
                            name="nikk" value="{{ old('nikk') ?? $siswa->nikk }}">
                        @error('nikk')
                            <div class="invalid-feedback text-danger">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control @error('kelurahan') is-invalid @enderror"
                            id="kelurahan" name="kelurahan" value="{{ old('kelurahan') ?? $siswa->kelurahan }}">
                        @error('kelurahan')
                            <div class="invalid-feedback text-danger">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control @error('kecamatan') is-invalid @enderror"
                            id="kecamatan" name="kecamatan" value="{{ old('kecamatan') ?? $siswa->kecamatan }}">
                        @error('kecamatan')
                            <div class="invalid-feedback text-danger">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control @error('kota') is-invalid @enderror" id="kota"
                            name="kota" value="{{ old('kota') ?? $siswa->kota }}">
                        @error('kota')
                            <div class="invalid-feedback text-danger">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control @error('provinsi') is-invalid @enderror"
                            id="provinsi" name="provinsi" value="{{ old('provinsi') ?? $siswa->provinsi }}">
                        @error('provinsi')
                            <div class="invalid-feedback text-danger">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="number" class="form-control @error('tahun_masuk') is-invalid @enderror"
                            id="tahun_masuk" name="tahun_masuk" value="{{ old('tahun_masuk') ?? $siswa->tahun_masuk }}">
                        @error('tahun_masuk')
                            <div class="invalid-feedback text-danger">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select name="aktif" class="form-select @error('aktif') is-invalid @enderror">
                            <option value="1" {{ (old('aktif') ?? $siswa->aktif) == '1' ? 'selected' : '' }}>Aktif
                            </option>
                            <option value="0" {{ (old('aktif') ?? $siswa->aktif) == '0' ? 'selected' : '' }}>Tidak
                                Aktif</option>
                        </select>
                        @error('aktif')
                            <div class="invalid-feedback text-danger">{{ $message }}</div>
