...
@section('content')
  ...
  <div class="card">
    <div class="card-header">
      <h3 class="mb-4"><i class="fa fa-edit"></i> Edit Siswa</h3>
      <form action="{{ route('siswa.update', $siswa->id) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="row">
          ...
          <div class="col-md-6 mb-3">
            ...
            <input type="number" class="form-control @error('tahun_masuk') is-invalid @enderror" id="tahun_masuk" name="tahun_masuk" value="{{ old('tahun_masuk') ?? $siswa->tahun_masuk }}">
            @error('tahun_masuk')
              <div class="invalid-feedback text-danger">{{ $message }}</div>
            @enderror
          </div>
          ...
          <div class="col-md-6 mb-3">
            ...
            <input type="number" class="form-control @error('penghasilan_ayah') is-invalid @enderror" id="penghasilan_ayah" name="penghasilan_ayah" value="{{ old('penghasilan_ayah') ?? $siswa->penghasilan_ayah }}">
          ...
          <div class="col-md-6 mb-3">
            ...
            <input type="number" class="form-control @error('penghasilan_ibu') is-invalid @enderror" id="penghasilan_ibu" name="penghasilan_ibu" value="{{ old('penghasilan_ibu') ?? $siswa->penghasilan_ibu }}">
          ...
          <div class="col-md-6 mb-3">
            ...
            <input type="number" class="form-control @error('penghasilan_wali') is-invalid @enderror" id="penghasilan_wali" name="penghasilan_wali" value="{{ old('penghasilan_wali') ?? $siswa->penghasilan_wali }}">
