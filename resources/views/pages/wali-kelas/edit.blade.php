      ...
      <form action="{{ route('wali-kelas.update', $waliKelas->id) }}" method="POST">
        ...
        <div class="row">
          <div class="col-md-6 mb-3">
            ...
            <input type="text" class="form-control @error('nama_guru') is-invalid @enderror" id="nama_guru" name="nama_guru" value="{{ old('nama_guru') ?? $waliKelas->nama_guru }}">
            @error('nama_guru')
          ...
          <div class="col-md-6 mb-3">
            ...
            <input type="text" class="form-control @error('nama_kelas') is-invalid @enderror" id="nama_kelas" name="nama_kelas" value="{{ old('nama_kelas') ?? $waliKelas->nama_kelas }}">
            @error('nama_kelas')
              <div class="invalid-feedback text-danger">
                {{ $message }}
              </div>
